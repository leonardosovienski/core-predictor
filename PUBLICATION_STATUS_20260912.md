# Estado de publicação e continuidade — Core
...
- Checkout de trabalho: `C:\PREDICTORS\core-predictor`.
- Branch de trabalho: `validation/retest-six-20260911`. Não presumir que `main` contém esta entrega.
- HEAD conferido antes desta atualização documental: `de79cc19914b70bd8a8fa74a6e49b4ea192c1f91`.
...
Foram inventariados 15 Markdown versionados antes da atualização, com hashes e verificação de leitura UTF-8. Inventário local: `C:\PREDICTORS\work\core-documentation-sync-20260912`.
