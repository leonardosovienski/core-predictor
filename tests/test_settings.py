...
from predictor_core import settings
...
def test_require_secrets_returns_valid_dict():
    env = {
        "GEMINI_API_KEY": "chave-real-suficientemente-longa-1",
...
def test_require_secrets_raises_listing_all_bad():
    env = {"GOOD_KEY": "chave-real-suficientemente-longa-1", "EMPTY": "", "PLACEHOLDER": "dummy"}
