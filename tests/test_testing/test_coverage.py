...
def test_coverage_iid():
    assert coverage_in_band(
        bootstrap_ci, "iid", n_series=300, n_points=350, phi=0.0, n_boot=200, seed=0
    )
...
def test_coverage_cluster():
    ...
    assert coverage_in_band(
        bootstrap_ci, "cluster", n_series=300, n_points=350, phi=0.0, n_boot=200, seed=0
    )
...
def test_coverage_test_has_power():
    ...
    assert not coverage_in_band(
        bootstrap_ci, "iid", n_series=160, n_points=300, phi=0.4, n_boot=200, seed=0
    )
