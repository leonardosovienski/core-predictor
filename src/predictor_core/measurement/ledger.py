...
class Ledger:
    ...
    def balance(self, account: str) -> float:
        ...
        return sum(p.amount for t in self.transactions for p in t.postings if p.account == account)
    ...
    def history(self, account: str) -> list:
        ...
        return [t for t in self.transactions if any(p.account == account for p in t.postings)]
