...
def edge_injected(
    base_series: list, edge_magnitude: float, positions=None, seed: int | None = None
) -> list:
...
def probabilistic_predictor(n: int, skill_level: float, seed: int, n_classes: int = 3) -> tuple:
